                                ...
                                <table dir="ltr" style="border: 0; width: 100%;" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="tw-card-body"
                                            ...
                                            <span style="font-weight: 400;">Please click the below button to change your password .The link will be valid for next ${expirationTime} minutes.</span><br/><br/><span
