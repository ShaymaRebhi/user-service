...
import com.proxym.poleactualities.Repository.PasswordResetTokenRepository;
import com.proxym.poleactualities.exception.InvalidTokenRequestException;
...
public class PasswordResetTokenServiceImpl {
     ...
     * would be generated. So, we need to invalidate all the existing password
